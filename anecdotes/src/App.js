...
const Anecdote = ({ anecdotes }) => {
  return (
    <div>
      <h2>{anecdotes.content}</h2>
      <p>
        has {anecdotes.votes} votes
        <button onClick={() => anecdotes.vote()}>vote</button>
      </p>
      <p>by {anecdotes.author}</p>
    </div>
  )
}
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          author
          <input name="author" {...authorField} reset={null} />
        </div>
        <div>
          url for more info
          <input name="info" {...infoField} reset={null} />
        </div>
...
const App = () => {
  ...
  return (
    <Routes>
      <Route path="/" element={<Layout notification={notification} />}>
